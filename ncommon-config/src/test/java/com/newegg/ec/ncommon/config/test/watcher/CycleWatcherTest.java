...
import com.newegg.ec.ncommon.config.watcher.CycleWatcher;
...
public class CycleWatcherTest {
	...
	private static final File PATH1 = new File(DIR, "aa1.properties");
	private static final File PATH2 = new File(DIR, "aa2.properties");
	private static final File PATH3 = new File(DIR, "aa3.properties");
	private static final File PATH4 = new File(DIR, "aa4.properties");
	private static final File PATH5 = new File(DIR, "aa5.properties");
	private static final File PATH6 = new File(DIR, "aa6.properties");
	
	private static final Watcher<LocalConfig<?>> watcher = new CycleWatcher<>(100);
